...
<!-- Test form en GET et uniquement le prénom en required : -->
	...
	<form class="" method="GET">
		...
		<fieldset>
			...
			<p class="">
				<label for="permis_sejour">Permis de travail / séjour :</label><br />
				<input type="checkbox" name="travail" /><label for="travail">Permis de travail</label><br />
				<input type="checkbox" name="sejour" /><label for="sejour">Permis de séjour</label><br />
			</p>
		...
		<fieldset>
			<h3>Langues :</h3>
				...
				<p>
					...
					<span id="slider1value"></span><span> %</span>
					<div style="max-width:250px" id="slider1"></div>
		...
		<fieldset>
			...
			<p>
				...
				<span id="slider2value"></span><span> %</span>
				<div style="max-width:250px" id="slider2"></div>
			</p>
			<h4>Voyages</h4>
			...
			<p class="">
				<input type="url" name="url_linkdein" id="url_linkdein" placeholder="Compte Linkedin"/>
				<label for="url_linkdein"></label>
			</p>
			<p class="">
			...
			<p class="">
				<input type="url" name="url_autre" id="url_autre" placeholder="Autre compte"/>
				<label for="url_autre"></label>
			</p>

...
/*    public function find($id_cv){
    ...
    public function find($id){
        ...
        foreach($resultat as $value){
            ...
            $experience[$id] = $this -> BuildEntityObject($value);
    ...
    public function findBenevolat($id_cv){
        $requete = "SELECT * FROM experience WHERE id_cv = ? AND type = 'benevolat'";
        $resultat = $this -> getDb() -> fetchAll($requete, array($id_cv));
        ...
        if($resultat){
            ...
            foreach ($resultat as $res) {
                ...
                $benevolat[] = $this -> buildEntityObject($res);
            }
    ...
    * @return \pimp\Entity\experience
    */
    public function saveNewExperience(Experience $experience){
        $experienceData = array(
            'id' => $experience -> getId(),
            'type' => $experience -> getType(),
            'nom' => $experience -> getNom(),
